...
if __name__ == '__main__':
    ...
    fcn32 = FCN32(nClasses, input_height, input_width)

    if os.path.exists('output/fcn32_model.h5'):
        fcn32.load_weights('output/fcn32_model.h5')
    ...
    checkpoint = ModelCheckpoint(
        filepath="output/fcn32_model.h5",
        monitor='acc',
        mode='auto',
    ...
    tensorboard = TensorBoard(log_dir='output/log_fcn32_model')
